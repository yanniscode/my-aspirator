import { Subscription, Observable, Subscriber, Subject, takeUntil, tap, finalize } from "rxjs";
import { RobotAspiratorService } from "../services/robot-actions/robot-aspirator.service";
import { Cell } from "./cell";
import { Position } from "./position";
import { RobotServiceData } from "./RobotServiceData";
...
export class RobotAspiratorModel {
    ...
    private log(message: string) {
        this.messageService.add(`RobotAspirator: ${message}`);
    }
